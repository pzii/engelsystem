...
class ShiftCalendarRenderer
{
    ...
    private function collectStartAndEndPerDay($shifts)
    {
        ...
        foreach ($shifts as $shift) {
            ...
            // Special case for shifts over midnight
            if ($startDate != $endDate) {
                $times[$startDate][1] = $shift->start;
                $times[$startDate][1]->hours = 23;
                $times[$startDate][1]->minutes = 59;

                $times[$endDate][0] = $shift->start;
                $times[$endDate][1]->hours = 0;
                $times[$endDate][1]->minutes = 0;
            } else {
                $date = $startDate;
