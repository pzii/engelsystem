...
class SettingsController extends BaseController
{
    ...
    public function profile(): Response
    {
        ...
        return $this->response->withView(
            ...
            [
                ...
                'userNameSsoSync' => $this->isFromSso('username'),
                'emailSsoSync' => $this->isFromSso('email'),
                'firstNameSsoSync' => $this->isFromSso('first_name'),
                'lastNameSsoSync' => $this->isFromSso('last_name'),
            ]
        );
    }
    ...
    {
        return $this->config->get('required_user_fields')[$key];
    }
    ...
    private function isFromSso(string $key): bool
    {
        $fromSso = false;
        foreach (config('oauth', []) as $name => $config) {
            if ($this->auth->user()->oauth->contains('provider', operator: $name)) {
                $fromSso = $fromSso || $config[$key . '_keep_sync'];
            }
        }
        return $fromSso;
    }
